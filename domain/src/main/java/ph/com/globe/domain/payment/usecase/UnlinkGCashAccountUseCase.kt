...
class UnlinkGCashAccountUseCase @Inject constructor(private val paymentManager: PaymentDataManager) :
    HasLogTag {

    suspend fun execute(params: LinkingGCashAccountParams): LfResult<Unit, LinkingGCashError> =
        paymentManager.unlinkGCashAccountNetworkCall(params)

    override val logTag = "DeleteGCashAccountUseCase"
}
