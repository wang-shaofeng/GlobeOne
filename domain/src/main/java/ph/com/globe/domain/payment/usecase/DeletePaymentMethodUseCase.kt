...
class DeletePaymentMethodUseCase @Inject constructor(private val paymentManager: PaymentDataManager) :
    HasLogTag {

    suspend fun execute(params: DeletePaymentMethodParams): LfResult<Unit, PaymentError> {
        return paymentManager.deletePaymentMethodNetworkCall(params)
    }

    override val logTag = "DeletePaymentMethodUseCase"
}
