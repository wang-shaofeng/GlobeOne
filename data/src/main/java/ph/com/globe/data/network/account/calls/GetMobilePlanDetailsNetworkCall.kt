...
class GetMobilePlanDetailsNetworkCall @Inject constructor(
    ...
    suspend fun execute(params: GetPlanDetailsParams): LfResult<GetMobilePlanDetailsResult, GetPlanDetailsError> {
        ...
        val response = kotlin.runCatching {
            accountRetrofit.getMobilePlanDetails(headers, params.toQueryMap())
        }.fold(Response<GetMobilePlanDetailsResponse>::toLfSdkResult, Throwable::toLFSdkResult)
    ...
    override val logTag = "GetMobilePlanDetailsNetworkCall"
}
