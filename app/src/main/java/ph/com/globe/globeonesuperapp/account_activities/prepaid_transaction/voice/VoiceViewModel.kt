...
import ph.com.globe.globeonesuperapp.account_activities.prepaid_transaction.VOICE_TRANSACTION_TYPE
...
class VoiceViewModel @Inject constructor(
    ...
    override suspend fun nextFetch() {
        ...
        prepaidDomainManager.getAccountManagementTransaction(
            transactionType = VOICE_TRANSACTION_TYPE,
    ...
    override val logTag = "VoiceViewModel"
}
