...
import ph.com.globe.globeonesuperapp.account_activities.prepaid_transaction.TOPUP_TRANSACTION_TYPE
...
class TopupViewModel @Inject constructor(
    ...
    override suspend fun nextFetch() {
        ...
        prepaidDomainManager.getAccountManagementTransaction(
            transactionType = TOPUP_TRANSACTION_TYPE,
    ...
    override val logTag = "TopupViewModel"
}
