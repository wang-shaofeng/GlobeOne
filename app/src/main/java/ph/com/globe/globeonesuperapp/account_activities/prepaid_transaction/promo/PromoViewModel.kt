...
import ph.com.globe.globeonesuperapp.account_activities.prepaid_transaction.PROMO_TRANSACTION_TYPE
...
class PromoViewModel @Inject constructor(
    ...
    override suspend fun nextFetch() {
        ...
        prepaidDomainManager.getAccountManagementTransaction(
            transactionType = PROMO_TRANSACTION_TYPE,
    ...
    override val logTag = "PromoViewModel"
}
