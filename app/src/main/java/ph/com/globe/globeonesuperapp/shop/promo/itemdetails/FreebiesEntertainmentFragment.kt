...
@AndroidEntryPoint
class FreebiesEntertainmentFragment @Inject constructor() :
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        with(viewBinding) {
            ...
            shopItemDetailsViewModel.singleSelectFreebiesLiveData.observe(
                viewLifecycleOwner,
                { freebies ->
                    freebiesSingleSelectRecyclerViewAdapter.submitList(freebies.filter { it.freebieSingleSelectItem.type == FREEBIE })
                })
        }
    }
    ...
    override val logTag = "FreebiesEntertainmentFragment"

    override val analyticsScreenName = "FreebiesEntertainmentFragment"
}
